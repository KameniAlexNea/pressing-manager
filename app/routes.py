...
import yaml
from fastapi import APIRouter, Depends, Form, HTTPException, Request, Body, Query
...
def update_status(item_id: str, status: str = Body(...), db: Session = Depends(database.get_db)):
